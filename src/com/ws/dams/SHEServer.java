...
public class SHEServer {
	...
	static void createHashMap() {
		...
		hashMap.put("Physician", Arrays.asList(new HashMapSubKey("SHEM310122", "2"),
											   new HashMapSubKey("SHEA300122", "2:MTLP2234:booked"),
				                               new HashMapSubKey("SHEE090222", "8:MTLP2234:booked"),
				                               new HashMapSubKey("SHEA040222", "0")));
		hashMap.put("Dental", new LinkedList<HashMapSubKey>());
		hashMap.put("Dental", Arrays.asList(new HashMapSubKey("SHEE300122", "3:MTLP2234:booked"),
											new HashMapSubKey("SHEM120222", "6")));
		hashMap.put("Surgeon", new LinkedList<HashMapSubKey>());
		hashMap.put("Surgeon",Arrays.asList(new HashMapSubKey("SHEA300122", "1:MTLP2234:booked"),
											new HashMapSubKey("SHEE191222", "0:MTLP2234:booked")));
		udpHashMap = hashMap;
		displayHashMap();
	}
			   ...
			   String newAppointmentID, String newAppointmentType) 
{
	...
	public static void udp_list_get_swap(SHEServer sheServer) {
		
		try {
		DatagramSocket udpSocket = new DatagramSocket(3333);
		byte[] buffer = new byte[1000];
		int listAvailableAppointment = 0;
		System.out.println("Sherbrooke UDP Server is Running");
		...
		while(true) {
			...
			udpHashMap = sheServer.getHashMapObj();
			String value;
			...
			if(bookAppointmentFlag == 1)
			{
				...
				returnFlag = bookAppointmentSherbrooke(appointmentID, appointmentType, patient, sheServer);
	...
	static int bookAppointmentSherbrooke(String appointmentID, String appointmentType, String patientID, SHEServer sheServer){
		List<HashMapSubKey> hsUpdate = new ArrayList<>();
		int capacity = -1;
		String addPatientID = null;
		String[] addInfoSplit = null;
	...
	public void sendRequestToFE(String requestString) {
		...
		String sendRequest = requestString +":" +"SHE1";
