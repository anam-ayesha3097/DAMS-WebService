...
public class QUEServer {
    ...
    static void createHashMap() {
        ...
        hashMap.put("Physician", Arrays.asList(new HashMapSubKey("QUEA270222", "2:MTLP2234:booked"),
        									   new HashMapSubKey("QUEE300122", "8:MTLP2234:booked"),
        									   new HashMapSubKey("QUEM020222", "6"),
        									   new HashMapSubKey("QUEM300122", "3:MTLP2234:booked"),
        									   new HashMapSubKey("QUEM111222", "1:MTLP1234:booked"),
        									   new HashMapSubKey("QUEE310122", "0:MTLP1234:booked")));
        hashMap.put("Dental", new LinkedList<HashMapSubKey>());
        hashMap.put("Dental", Arrays.asList(new HashMapSubKey("QUEA310122", "3:MTLP2234:booked"),
        									new HashMapSubKey("QUEE070222", "4:MTLP2234:booked"),
        									new HashMapSubKey("QUEE101122", "4:MTLP2234:booked"),
        									new HashMapSubKey("QUEE030922", "0")));
        hashMap.put("Surgeon", new LinkedList<HashMapSubKey>());
        hashMap.put("Surgeon",Arrays.asList(new HashMapSubKey("QUEA310122", "1"),
        									new HashMapSubKey("QUEM050922", "1")));
        udpHashMap = hashMap;
        displayHashMap();
    }
    ...
    public void sendRequestToFE(String request) {

        String sendRequest = request +":" +"QUE1";
        ...
        try {
            ...
            DatagramPacket requestSend = null;
            requestSend = new DatagramPacket(udpBytesRequest, sendRequest.length(), udpClientHost, serverPort);
            System.out.println("Before send " +requestSend);
            udpClient.send(requestSend);
            ...
            System.out.println("Exception in QUEBEC Server "+e);
        }
    }
								...
								for(String aptID: valSplit) {
									...
									if(aptID.equalsIgnoreCase(newAppointmentID)) {
										...
										if(valSplit[1] != "0") {
											...
											{
												System.out.println("Inside Else QUE");
    ...
    public static void udp_list_get_swap(QUEServer queServer) {

        try {
            DatagramSocket udpSocket = new DatagramSocket(2222);
            byte[] buffer = new byte[1000];
            int listAvailableAppointment = 0;
            System.out.println("Quebec UDP Server is Running");
            ...
            while(true) {
                ...
                udpHashMap = queServer.getHashMapObj();
                String value;
                ...
                if(bookAppointmentFlag == 1)
                {
                    ...
                    returnFlag = bookAppointmentQuebec(appointmentID, appointmentType, patient, queServer);
	...
	static int bookAppointmentQuebec(String appointmentID, String appointmentType, String patientID, QUEServer queServer){
		List<HashMapSubKey> hsUpdate = new ArrayList<>();
		int capacity = -1;
		String addPatientID = null;
		String[] addInfoSplit = null;
