...
public class ReplicaManager1 {
	...
	public static void main(String args[]) throws IOException {
		...
		fileHandler = new FileHandler("E:/COMP-6231/DAMS Project/logs/Replica Manager 1.txt");
		simpleFormatter = new SimpleFormatter();
		LOGGER.setUseParentHandlers(false);
		LOGGER.addHandler(fileHandler);
		fileHandler.setFormatter(simpleFormatter);
		LOGGER.info("Log File: Replica Manager 1");
	...
	public void udpConnect() {
		LOGGER.info("Method: UDP Connect");
		try {
			DatagramSocket udpSocket = new DatagramSocket(2001);
	...
	public void send(String finalRequestString, String replicaName) {
	    ...
	    case 3 : {
	    	LOGGER.info("Method Request by Admin : List Available Appointment");
	    	String appointmentType = split[1];
	    ...
	    default : {
	    	...
	    	LOGGER.info("Default Case for Admin: Invalid Input");
	    	break;
	    }
	    }
	    break;
	    ...
	    case 4:{
	    	LOGGER.info("Method Request by Patient : Swap Appointment Appointment");
	    	System.out.print("Replica Name: "+ replicaName);
	    	String oldAppointmentType=split[1];
	    	String oldAppointmentID= split[2];
	    	String newAppointmentType=split[3];
